...
Route::get('/adm', function () {return view('adm');})->name('adm')->middleware('auth');
Route::get('/adm1', function () {return view('adm1');})->name('adm1')->middleware('auth');
Route::get('/adm11', function () {return view('adm11');})->name('adm11')->middleware('auth');
